...
const SheetHeader = ({ className, ...props }: ComponentProps<"div">) => {
  return (
    <div
      ...
      className={classMerger("flex flex-col gap-1.5 p-4", className)}
      {...props}
    />
  )
}
...
const SheetFooter = ({ className, ...props }: ComponentProps<"div">) => {
  return (
    <div
      ...
      className={classMerger("mt-auto flex flex-col gap-2 p-4", className)}
      {...props}
    />
  )
}
...
const SheetTitle = ({
  ...
  return (
    <SheetPrimitive.Title
      ...
      className={classMerger("text-neutral-950 font-semibold dark:text-neutral-50", className)}
      {...props}
    />
  )
}
